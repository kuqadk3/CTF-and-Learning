...
Beside Static analysis and Dynamic Analysis, Dataflow Analysis is also another common type of analysis which use techniques like taint analysis and symbolic execution from Dynamic Analysis to track the data sources like registers,... 
